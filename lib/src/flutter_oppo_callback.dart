...
///banner广告回调
class FlutterOppoadBannerCallBack {
  TOnShow? onShow;
  TOnFail? onFail;
  TOnClick? onClick;
  TOnExpose? onExpose;
...
///动态信息流/横幅/视频贴片广告回调
class FlutterOppoadExpressCallBack {
  TOnShow? onShow;
  TOnFail? onFail;
  TOnClick? onClick;
  TOnExpose? onExpose;
...
///开屏广告回调
class FlutterOppoadSplashCallBack {
  TOnClose? onClose;
  TOnShow? onShow;
  TOnFail? onFail;
  TOnClick? onClick;
...
///插屏广告回调
class FlutterOppoadInteractionCallBack {
  TOnShow? onShow;
  TOnClick? onClick;
  TOnClose? onClose;
  TOnFail? onFail;
  ...
  FlutterOppoadInteractionCallBack(
      {this.onShow,
      this.onClick,
      this.onClose,
      this.onFail,
...
///激励广告回调
class FlutterOppoadRewardCallBack {
  TOnShow? onShow;
  TOnClose? onClose;
  TOnExpose? onExpose;
  TOnFail? onFail;
